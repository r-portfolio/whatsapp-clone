...
export class DocumentPreviewController {
  ...
  /**
   * Returns a Promise according to the requested file type.
   *
    ...
    return new Promise((s, f) => {
      ...
      switch (this._file.type) {
        ...
        case "application/pdf":
          /**
           * Get the pdf, convert to an 8-bit array.
           * Read the first page and create an element with the render of this page.
           */
          reader.onload = e => {
            pdfjsLib
